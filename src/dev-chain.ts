...
export async function getDevChainFunds() {
    ...
    if (ChainInternal.instance._ethereum.isMetaMask) {
        ...
        const WBTC = IERC20Mock.at('0x6D411e0A54382eD43F02410Ce1c7a7c122afA6E1');
        ...
        const WETH = IERC20Mock.at('0x5CF7F96627F3C9903763d128A1cc5D97556A6b99');
        ...
        const BNB = IERC20Mock.at('0xA3183498b579bd228aa2B62101C40CC1da978F24');
        ...
        const WXRP = IERC20Mock.at('0x63f58053c9499E1104a6f6c6d2581d6D83067EEB');
        ...
        const USDT = IERC20Mock.at('0x66a15edcC3b50a663e72F1457FFd49b9AE284dDc');
